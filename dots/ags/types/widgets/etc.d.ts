...
export type CalendarProps<Attr> = BaseProps<
    Calendar<Attr>,
...
export type ColorButtonProps<Attr> = BaseProps<
    ColorButton<Attr>,
...
export type DrawingAreaProps<Attr> = BaseProps<
    DrawingArea<Attr>,
...
export type FileChooserButtonProps<Attr> = BaseProps<
    FileChooserButton<Attr>,
...
export declare class FileChooserButton<Attr> extends Gtk.FileChooserButton {
    constructor(
        props: BaseProps<FileChooserButton<Attr>, Gtk.FileChooserButton.ConstructorProperties, Attr>
    );
}
...
export type FontButtonProps<Attr> = BaseProps<
    FontButton<Attr>,
...
export type LevelBarProps<Attr> = BaseProps<
    LevelBar<Attr>,
...
export type SeparatorProps<Attr> = BaseProps<
    Separator<Attr>,
...
export type SpinButtonProps<Attr> = BaseProps<
    SpinButton<Attr>,
...
export type ToggleButtonProps<Attr> = BaseProps<
    ToggleButton<Attr>,
